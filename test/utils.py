...
def run_accelergy(inputs: List[str], plug_ins: List[str], run_dir: str,
    ...
    ert_summary_verbose = grab_content_if_file_exists(
        'ERT_summary_verbose.txt')
    art_summary_verbose = grab_content_if_file_exists(
...
class AccelergyUnitTest(unittest.TestCase):
    ...
    def compare_yamls(self, yaml1: str, yaml2: str, ignore_keys: List = ()):
        ...
        diff = DeepDiff(yaml1, yaml2, ignore_order=True, ignore_numeric_type_changes=True,
                        ignore_string_type_changes=True, number_format_notation='e', significant_digits=3)
